...
class AutomatonTest < Minitest::Test
  ...
  def test_minimaze_divisible_by_5_1
    dfa = DFA::Automaton.new(transitions:
                             { q0: { q0: '0', q1: '1' },
                               q1: { q2: '0', q3: '1' },
                               q2: { q4: '0', q0: '1' },
    ...
    dfa.minimaze!
    assert_equal dfa.states.size, 1
    assert_equal dfa.states[:q0].edges[:self_referenced].first.value, '0|1(10)*(0|11)(01*01|01*00(10)*(0|11))*1'
  end

  def test_minimaze_divisible_by_5_2
    dfa = DFA::Automaton.new(transitions:
                             { q0: { q0: '0', q1: '1' },
                               q1: { q2: '0', q4: '1' },
                               q2: { q3: '0', q0: '1' },
